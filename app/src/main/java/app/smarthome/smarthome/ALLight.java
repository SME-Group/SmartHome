...
public class ALLight extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_allight);

        Status = (TextView)findViewById(R.id.txtALLight);
        Status2 = (ImageView)findViewById(R.id.imgALLight);

        final GlobalValue globalValue = (GlobalValue) getApplicationContext();
        Bool = globalValue.getLivingRoomBool();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_allight, menu);
        return true;
    }
